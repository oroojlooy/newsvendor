...
for i in range(cluster):
        random_demand[i][:] = np.random.lognormal(1+0.1*(i+1), 0.5 + 0.1*(i+1), total)
...
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/lognormal/IndexX-nw-10000-10-class', mdict={'IndexX': ind})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/lognormal/IndexY-nw-10000-10-class', mdict={'IndexY': indt})


sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/lognormal/TrainX-nw-10000-10-class', mdict={'trainX': X})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/lognormal/TrainY-nw-10000-10-class', mdict={'trainY': y})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/lognormal/TestX-nw-10000-10-class', mdict={'testX': Xt})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/lognormal/TestY-nw-10000-10-class', mdict={'testY': yt})

...
for i in range(cluster):
        random_demand[i][:] = 100*np.random.beta(0.6*(i+1), 0.6*(i+1), total)
...
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/beta/IndexX-nw-10000-10-class', mdict={'IndexX': ind})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/beta/IndexY-nw-10000-10-class', mdict={'IndexY': indt})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/beta/TrainX-nw-10000-10-class', mdict={'trainX': X})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/beta/TrainY-nw-10000-10-class', mdict={'trainY': y})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/beta/TestX-nw-10000-10-class', mdict={'testX': Xt})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/beta/TestY-nw-10000-10-class', mdict={'testY': yt})

...
for i in range(cluster):
        random_demand[i][:] = np.random.randint(0.5*(i+1), 15+0.5*(i+1), total)
...
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/uniform/IndexX-nw-10000-203-class', mdict={'IndexX': ind})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/uniform/IndexY-nw-10000-203-class', mdict={'IndexY': indt})

sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/uniform/TrainX-nw-10000-203-class', mdict={'trainX': X})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/uniform/TrainY-nw-10000-203-class', mdict={'trainY': y})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/uniform/TestX-nw-10000-203-class', mdict={'testX': Xt})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/uniform/TestY-nw-10000-203-class', mdict={'testY': yt})

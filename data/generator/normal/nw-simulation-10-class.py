...
for i in range(cluster):
        random_demand[i][:] = np.random.normal(50*(i+1), 10*(i+1), total)
...
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/normal/IndexX-nw-10000-10-class', mdict={'IndexX': ind})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/normal/IndexY-nw-10000-10-class', mdict={'IndexY': indt})

sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/normal/TrainX-nw-10000-10-class', mdict={'trainX': X})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/normal/TrainY-nw-10000-10-class', mdict={'trainY': y})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/normal/TestX-nw-10000-10-class', mdict={'testX': Xt})
sio.savemat('/home/afo214/tensorflow/newsvendor/simulation/data/normal/TestY-nw-10000-10-class', mdict={'testY': yt})
